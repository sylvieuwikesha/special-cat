...
require_once 'gitConfiguration.php';
...
if(isset($accessToken)){
    ...
    $output = '<a style="background:black; text-decoration: none; color: white; padding: 6px; border-radius:4px;" href="'.htmlspecialchars($loginURL).'">Continue with GitHUB</a>';
